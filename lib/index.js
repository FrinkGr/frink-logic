...
var Frinks = function (context, options) {
  ...
  this.info = {
    ...
    country: this.context.country || 'gr',
    tzwhere : tzwhere,
    ...
    effectiveFrom: this.effectiveFrom.format(),
    effectiveUntil: this.effectiveUntil.format(),
    venues: {}
  };
  console.log(this.effectiveDate.format(), this.info.tzwhere);
};
...
Frinks.prototype.sync = function (adapter, callback) {
  ...
  adapter
    ...
    .findOne({id: that.info.id, country: that.info.country}, function (error, frinks) {
...
Frinks.prototype.reserve = function (adapter, venue, callback) {
  var that = this;
  var matchQuery = {id: that.info.id, country: that.info.country};
